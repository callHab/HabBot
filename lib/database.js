...
try {
  ...
  // <<-- PENINGKATAN: Jika file korup, data di memori akan direset.
  // Pertimbangkan untuk memberi tahu owner bot atau mencoba memuat dari backup di sini.
  usersDB = {}
}
...
try {
  ...
  // <<-- PENINGKATAN: Sama seperti usersDB, pertimbangkan notifikasi atau backup.
  commandsDB = {}
}
